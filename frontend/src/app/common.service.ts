...
export class CommonService {
  ...
  public getTaskData(): Observable<Task[]> {
    return this.http.get<Task[]>(`${this.apiUrl}/getTaskDeatils`);
  }
  ...
  public getTaskById(id: string) {
    return this.http.get(`${this.apiUrl}/getTaskbyId/${id}`);
  }

  public upadteTask(id: string, taskdata: Task) {
    return this.http.put(`${this.apiUrl}/updateTask/${id}`, taskdata);
  }
}
